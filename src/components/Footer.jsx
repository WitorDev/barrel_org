            ...
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <div className="flex sm:flex-row flex-col justify-between">
                    <div className="sm:pr-10 mb-8">
                        ...
                        <p className="text-lg sm:max-w-1/2">Empowering through knowledge and skills</p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul>
                            <li className="mb-2">
                                <p className="text-lg">
                                    <Link to="/home" className="text-yellow-500 hover:border-b-4 hover:border-slate-500">
                                        Home
                                    </Link>
                                </p>
                            </li>
                            <li className="mb-2">
                                <p className="text-lg">
                                    <Link to="/about" className="text-yellow-500 hover:border-b-4 hover:border-slate-500">
                                        About
                                    </Link>
                                </p>
                            </li>
